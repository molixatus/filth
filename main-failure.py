...
#_______________________________________________________________________________LEFT  LEFT  LEFT  LEFT  LEFT  LEFT  LEFT
        ...
        if (vec.length() != 0):
            ...
            #clip the x/y
            if int(Tile2.collisionmap[int(self.pos.y / 32)][int((self.pos.x + 1) / 32)]) == 0 or int(Tile2.collisionmap[int(self.pos.y / 32)][int((self.pos.x + 30) / 32)]) == 0:
                self.pos.y = int((self.pos.y + 32) / 32) * 32

            if int(Tile2.collisionmap[int((self.pos.y + 31) / 32)][int((self.pos.x + 1) / 32)]) == 0 or int(Tile2.collisionmap[int((self.pos.y + 31) / 32)][int((self.pos.x + 30) / 32)]) == 0:
                self.pos.y = int((self.pos.y - 0) / 32) * 32


            if int(Tile2.collisionmap[int((self.pos.y + 1) / 32)][int((self.pos.x) / 32)]) == 0 or int(Tile2.collisionmap[int((self.pos.y + 30) / 32)][int((self.pos.x) / 32)]) == 0:
                self.pos.x = int(self.pos.x / 32) * 32

            if int(Tile2.collisionmap[int((self.pos.y + 1) / 32)][int((self.pos.x + 31) / 32)]) == 0 or int(Tile2.collisionmap[int((self.pos.y + 30) / 32)][int((self.pos.x + 31) / 32)]) == 0:
